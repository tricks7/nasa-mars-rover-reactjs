...
const Rover = () => {
  ...
  return (
    ...
    alignItems="center">
      ...
      <CardActions>
      <Button component={Link} to="/Spirit" variant="contained" color="primary">Spirit Photos</Button>
      </CardActions>
      </Card>
      ...
      <CardActions>
      <Button component={Link} to="/Opportunity" variant="contained" color="primary">Opportunity Photos</Button>
      </CardActions>
      </Card>
      ...
      <CardActions>
      <Button component={Link} to="/Perseverance" variant="contained" color="primary">Perseverance Photos</Button>
      </CardActions>
      </Card>
      </Grid>
    </>
